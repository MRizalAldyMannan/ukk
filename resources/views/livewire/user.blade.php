                            ...
                            <tbody>
                                @foreach ($semuaPengguna as $pengguna )
                                    <tr>
                                        ...
                                        <td>
                                            <button wire:click="pilihEdit({{ $pengguna->id }})" class="btn btn-sm btn-outline-primary">
                                                Edit
                                            </button>
                                            <button wire:click="pilihHapus({{ $pengguna->id }})" class="btn btn-sm btn-outline-danger">
                                                Hapus
                                            </button>
                                        </td>
                                    </tr>
